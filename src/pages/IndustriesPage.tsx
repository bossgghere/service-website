        ...
        <div className="max-w-7xl mx-auto relative z-10 min-w-0">
          ...
          <Reveal delay={160}>
            <p className="text-lg sm:text-xl md:text-2xl font-light text-neutral-300 max-w-2xl leading-relaxed">
              Tailored technology and managed services for financial, government, healthcare, and more.
            </p>
          </Reveal>
        </div>
      </section>
        ...
        {industries.map((industry, idx) => (
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 items-center">
              <Reveal className={idx % 2 === 1 ? 'md:col-start-2 md:row-start-1' : ''} delay={0}>
              ...
              <Reveal className={idx % 2 === 1 ? 'md:col-start-1 md:row-start-1' : ''} delay={100}>
